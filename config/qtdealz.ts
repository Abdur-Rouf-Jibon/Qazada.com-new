...
const qtdealz: ConfigsType = {
  ...
  contact: {
    whatsapp: "https://wa.me/message/FKMB7WT5ZHLIJ1",
    email: "Info@Qazada.com",
    address: "Dee Vinci International FZE LLC . Media City. United Arab Emirates",
    phone: "+971564259474",
  },
  product: {
    currency: "AED",
    ...
    whatsappShare: "https://wa.me/message/FKMB7WT5ZHLIJ1",
  ...
  head: {
    home: {
      title:
        "Qazada - Online shopping in Middle East. Fashion , Apparel, Shoes, Tops,  & More . 80 % OFF. High Quality Low Prices",
      description: "Discount online shopping in Middle East. Dubai UAE QATAR OMAN KSA",
      ...
      imgURL: `${
        process.env.NEXT_PUBLIC_URL && "https://qazada-com-new.vercel.app"
      }/images/qazada-meta-logo.jpg`,
    },
    newArrivalCat: {
